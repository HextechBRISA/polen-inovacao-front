...
export default function BackgroundForms({ children }: BackgroundFormsProps) {
  return (
    <div className="bg-white bg-opacity-30 w-1/2 mt-[130px] mx-auto rounded-[20px] p-10 shadow-lg flex flex-col items-center justify-center sm:w-4/5 xs:w-4/5 text-[#635A56]">
