          ...
          {mentor.map((mentor, index) => (
            <>
              <Link href={"/mentor/mentor-profile"}>
                <div
                  key={index}
                  className="w-40 h-[200px] p-6 bg-[#eadcd3] bg-opacity-70 rounded-2xl mb-6 cursor-pointer flex flex-col justify-center items-center shadow-md hover:bg-opacity-100 transition duration-500 hvr-push"
                >
                  <Image
                    src={Mentor}
                    alt="Item 2"
